...
def predictcnn_alz(fn):
    ...
    mo = load_model(r"D:\softwares\Project\diabetic\model_alz.h5")
...
# pred=predictcnn_alz(r"D:\softwares\Project\diabetic\myapp\static\Alzheimers\Healthy\non_5.jpg")
